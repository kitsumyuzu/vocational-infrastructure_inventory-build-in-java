...
public class ruang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        rooms_input = new javax.swing.JTextField();
        ...
        rooms_input.setForeground(new java.awt.Color(0, 0, 0));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, contentLayout.createSequentialGroup()
                ...
                .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(rooms_input, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        contentLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, contentLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(rooms_input, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(total_data))
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Ruangan", "Kode Ruangan", "Keterangan"
            }
        ));
                    ...
                    .addGroup(dataLayout.createSequentialGroup()
                        .addGroup(dataLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(dataLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(id_ruang, javax.swing.GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE)))
                        .addGap(0, 0, Short.MAX_VALUE))
        ...
        int valid = JOptionPane.showConfirmDialog(null, "Are you sure want to delete this data?", "Confirm", JOptionPane.OK_CANCEL_OPTION);
            ...
            if (valid == 0) {
                ...
                try {
                    ...
                    String row_id = id_ruang.getText();
                    String sql = "DELETE FROM jenis WHERE id_ruang = '"+ row_id + "'";
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (!"0".equals(row_id)) {
            ...
            try {
                ...
                String sql = "SELECT * FROM ruang WHERE ruang.id_ruang = '"+ row_id +"'";
                ...
                if (res.next()) {
                    ...
                    String codes = res.getString("kode_ruang");

                    form_title.setText("Updating data - " + codes);

                    id_ruang.setText(res.getString("id_ruang"));
                    rooms_input.setText(res.getString("nama_ruang"));
                    code_input.setText(codes);
                    description_input.setText(res.getString("keterangan"));

                    rooms_input.requestFocus();
    ...
    private void btn_saveActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String row_id = id_ruang.getText();
        String row_Type = rooms_input.getText();
        ...
        int code = 0;
            ...
            if (!"".equals(row_Type) && !"".equals(row_codeType) && !"".equals(row_descType)) {
                ...
                try {
                    ...
                    String sql = "SELECT COUNT(ruang.id_ruang) as count FROM ruang WHERE ruang.kode_ruang = '"+ row_codeType +"'";
                ...
                if ("".equals(row_id)) {
                    ...
                    if (code == 0) {
                        ...
                        try {
                            ...
                            String sql = "INSERT INTO ruang(nama_ruang, kode_ruang, keterangan) VALUES ('"+ row_Type +"', '"+ row_codeType +"', '"+ row_descType +"')";
                    ...
                    if (code == 0 || row_id.equals(row_id)) {
                        ...
                        try {
                            ...
                            String sql = "UPDATE ruang SET nama_ruang='"+ row_Type +"', kode_ruang='"+ row_codeType +"', keterangan='"+ row_descType +"' WHERE id_ruang = '"+ row_id +"'";
    ...
    private javax.swing.JTextField rooms_input;
